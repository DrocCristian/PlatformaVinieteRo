...
Public pages: Romanian at / and /catalog; Hungarian at /hu and /hu/catalog; German at /de and /de/catalog; Italian at /it and /it/catalog.
...
Each page has a self-referencing canonical on https://vignexo.com and reciprocal language alternatives, including x-default to Romanian. The sitemap at /sitemap.xml contains exactly these eight real pages, with no accounts, authentication, APIs, fragment URLs or fictional products. Dates are not fabricated.
...
Only the active language dictionary is passed to client components. No third-party translation service, geolocation redirects or extra map library is loaded. A lang attribute on the public content container identifies its language; the global shell and account area remain Romanian.
