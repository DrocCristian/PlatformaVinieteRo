...
const config:NextConfig={
 env:{FLEET_WORKSPACE_ENABLED:previewWorkspace?'true':process.env.FLEET_WORKSPACE_ENABLED??'false',PURCHASE_WORKSPACE_ENABLED:previewWorkspace?'true':process.env.PURCHASE_WORKSPACE_ENABLED??'false'},
