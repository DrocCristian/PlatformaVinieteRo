...
export default function TravelPeriods({selected,periods,onChange,error,messages={}}:{selected:CountryCode[];periods:Partial<Record<CountryCode,TravelPeriod>>;onChange:(code:CountryCode,value:TravelPeriod)=>void;error:string;messages?:Messages}){
