...
export default function PurchaseDemo({ saved, onPrepare, embedded = false, locale = 'ro', messages = {} }: {
    ...
    function next() {
        ...
        if(step===2&&!saved)Object.assign(current,validatePurchaseTechnical(technicalProfile,vehicle,trailer,selections.map(s=>s.country)));
        setErrors(current);
